 ...
 */
package com.ckw.services.google;
...
/**
 * Demo of listing broadcasts using the YouTube Live API (V3) with OAuth2 for
 * authorization.
 *
...
public class ListBroadcasts {
     ...
     * @return
     */
    public List<LiveBroadcast> listOfBroadcastLive() {
        ...
        try {
            ...
            YouTube.LiveBroadcasts.List liveBroadcastRequest
                    = youtube.liveBroadcasts().list("id,snippet,contentDetails");
            ...
            for (LiveBroadcast broadcast : returnedList) {
                ...
                if (contentDetails != null) {
                    ...
                    LiveBroadcastContentDetails.MonitorStream monitorStream = contentDetails.getMonitorStream();
                    if (monitorStream != null) {
                        System.out.println("EmbedHtml: " + monitorStream.getEmbedHtml());
                    }
                }
            }
