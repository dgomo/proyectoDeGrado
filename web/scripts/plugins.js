+function(t) {
    ...
    e.RESET = "affix affix-top affix-bottom", e.DEFAULTS = {offset: 0}, e.prototype.getPinnedOffset = function() {
        ...
        if (this.$element.is(":visible")) {
            var i = t(document).height(), o = this.$window.scrollTop(), s = this.$element.offset(), n = this.options.offset, r = n.top, a = n.bottom;
            "object" != typeof n && (a = r = n), "function" == typeof r && (r = n.top(this.$element)), "function" == typeof a && (a = n.bottom(this.$element));
            var l = null != this.unpin && o + this.unpin <= s.top ? !1 : null != a && s.top + this.$element.height() >= i - a ? "bottom" : null != r && r >= o ? "top" : !1;
            if (this.affixed !== l) {
                null != this.unpin && this.$element.css("top", "");
                var h = "affix" + (l ? "-" + l : ""), p = t.Event(h + ".bs.affix");
                this.$element.trigger(p), p.isDefaultPrevented() || (this.affixed = l, this.unpin = "bottom" == l ? this.getPinnedOffset() : null, this.$element.removeClass(e.RESET).addClass(h).trigger(t.Event(h.replace("affix", "affixed"))), "bottom" == l && this.$element.offset({top: s.top}))
            }
        }
    };
    var i = t.fn.affix;
    ...
    n.prototype.toggle = function(o) {
        ...
        if (!s.is(".disabled, :disabled")) {
            ...
            if (e(), !r) {
                ...
                if (n.trigger(o = t.Event("show.bs.dropdown", a)), o.isDefaultPrevented())
                    return;
    ...
    e.DEFAULTS = {animation: !0, placement: "top", selector: !1, template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover focus", title: "", delay: 0, html: !1, container: !1, viewport: {selector: "body", padding: 0}}, e.prototype.init = function(e, i, o) {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var s = "function" == typeof this.options.placement ? this.options.placement.call(this, o[0], this.$element[0]) : this.options.placement, n = /\s?auto?\s?/i, r = n.test(s);
            r && (s = s.replace(n, "") || "top"), o.detach().css({top: 0, left: 0, display: "block"}).addClass(s), this.options.container ? o.appendTo(this.options.container) : o.insertAfter(this.$element);
            var a = this.getPosition(), l = o[0].offsetWidth, h = o[0].offsetHeight;
            if (r) {
                var p = s, d = this.$element.parent(), c = this.getPosition(d);
                s = "bottom" == s && a.top + a.height + h - c.scroll > c.height ? "top" : "top" == s && a.top - c.scroll - h < 0 ? "bottom" : "right" == s && a.right + l > c.width ? "left" : "left" == s && a.left - l < c.left ? "right" : s, o.removeClass(p).addClass(s)
            }
            var f = this.getCalculatedOffset(s, a, l, h);
            this.applyPlacement(f, s), this.hoverState = null;
            var u = function() {
                i.$element.trigger("shown.bs." + i.type)
            };
            t.support.transition && this.$tip.hasClass("fade") ? o.one(t.support.transition.end, u).emulateTransitionEnd(150) : u()
        }
        ...
        var d = p.left ? 2 * p.left - s + l : 2 * p.top - n + h, c = p.left ? "left" : "top", f = p.left ? "offsetWidth" : "offsetHeight";
    ...
    t.fn.modal = function(i, o) {
        return this.each(function() {
            var s = t(this), n = s.data("bs.modal"), r = t.extend({}, e.DEFAULTS, s.data(), "object" == typeof i && i);
    ...
    e.DEFAULTS = {interval: 5e3, pause: "hover", wrap: !0}, e.prototype.cycle = function(e) {
        ...
        var h = t.Event("slide.bs.carousel", {relatedTarget: s[0], direction: r});
        return this.$element.trigger(h), h.isDefaultPrevented() ? void 0 : (this.sliding = !0, n && this.pause(), this.$indicators.length && (this.$indicators.find(".active").removeClass("active"), this.$element.one("slid.bs.carousel", function() {
            ...
            e && e.addClass("active")
        })), t.support.transition && this.$element.hasClass("slide") ? (s.addClass(e), s[0].offsetWidth, o.addClass(r), s.addClass(r), o.one(t.support.transition.end, function() {
    ...
    t.fn.carousel = function(i) {
        return this.each(function() {
            var o = t(this), s = o.data("bs.carousel"), n = t.extend({}, e.DEFAULTS, o.data(), "object" == typeof i && i), r = "string" == typeof i ? i : n.slide;
            s || o.data("bs.carousel", s = new e(this, n)), "number" == typeof i ? s.to(i) : r ? s[r]() : n.interval && s.pause().cycle()
        })
    }, t.fn.carousel.Constructor = e, t.fn.carousel.noConflict = function() {
        return t.fn.carousel = i, this
    }, t(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", function(e) {
        var i, o = t(this), s = t(o.attr("data-target") || (i = o.attr("href")) && i.replace(/.*(?=#[^\s]+$)/, "")), n = t.extend({}, s.data(), o.data()), r = o.attr("data-slide-to");
        r && (n.interval = !1), s.carousel(n), (r = o.attr("data-slide-to")) && s.data("bs.carousel").to(r), e.preventDefault()
    }), t(window).on("load", function() {
    ...
    e.DEFAULTS = {offset: 10}, e.prototype.refresh = function() {
        ...
        var t, e = this.$scrollElement.scrollTop() + this.options.offset, i = this.$scrollElement[0].scrollHeight || Math.max(this.$body[0].scrollHeight, document.documentElement.scrollHeight), o = i - this.$scrollElement.height(), s = this.offsets, n = this.targets, r = this.activeTarget;
        if (e >= o)
            return r != (t = n.last()[0]) && this.activate(t);
        if (r && e <= s[0])
    ...
    e.DEFAULTS = {toggle: !0}, e.prototype.dimension = function() {
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(e), !e.isDefaultPrevented()) {
                ...
                var n = function(e) {
                    return e && e.target != this.$element[0] ? void this.$element.one(t.support.transition.end, t.proxy(n, this)) : (this.$element.removeClass("collapsing").addClass("collapse in")[s](""), this.transitioning = 0, void this.$element.trigger("shown.bs.collapse"))
                };
                if (!t.support.transition)
                    return n.call(this);
                var r = t.camelCase(["scroll", s].join("-"));
                this.$element.one(t.support.transition.end, t.proxy(n, this)).emulateTransitionEnd(350)[s](this.$element[0][r])
            }
        }
    }, e.prototype.hide = function() {
        if (!this.transitioning && this.$element.hasClass("in")) {
    ...
    t.fn.collapse = function(i) {
        ...
        var i, o = t(this), s = o.attr("data-target") || e.preventDefault() || (i = o.attr("href")) && i.replace(/.*(?=#[^\s]+$)/, ""), n = t(s), r = n.data("bs.collapse"), a = r ? "toggle" : o.data(), l = o.attr("data-parent"), h = l && t(l);
        r && r.transitioning || (h && h.find('[data-toggle="collapse"][data-parent="' + l + '"]').not(o).addClass("collapsed"), o[n.hasClass("in") ? "addClass" : "removeClass"]("collapsed")), n.collapse(a)
    })
}(jQuery), +function(t) {
    "use strict";
    var e = function(e) {
    ...
    e.prototype.show = function() {
        ...
        r ? n.one(t.support.transition.end, s).emulateTransitionEnd(150) : s(), n.removeClass("in")
    };
    var i = t.fn.tab;
    t.fn.tab = function(i) {
        return this.each(function() {
